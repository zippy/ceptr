...
void base_defs() {
  ...
  sP(SYS_CONTEXT,EXPECT_ACT,"block run tree until expectation met and then act","result",SIGNATURE_STRUCTURE,TREE,"on",SIGNATURE_SYMBOL,CARRIER,"expectation",SIGNATURE_STRUCTURE,SEMTREX,"with",SIGNATURE_SYMBOL,PARAMS,"do",SIGNATURE_PROCESS,QUOTE,0);
