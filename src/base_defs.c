...
void base_defs() {
  ...
  sP(SYS_CONTEXT,REQUEST,"send a request to a receptor","response",SIGNATURE_STRUCTURE,TREE,"of",SIGNATURE_SYMBOL,RECEPTOR_ADDRESS,"on",SIGNATURE_SYMBOL,ASPECT,"message",SIGNATURE_ANY,NULL_STRUCTURE,"respond on",SIGNATURE_SYMBOL,RESPONSE_CARRIER,"until",SIGNATURE_OPTIONAL,SIGNATURE_SYMBOL,END_CONDITIONS,"callback",SIGNATURE_OPTIONAL,SIGNATURE_PROCESS,NULL_SYMBOL,0);
  sP(SYS_CONTEXT,LISTEN,"plant a listener","error",SIGNATURE_SYMBOL,REDUCTION_ERROR_SYMBOL,"on",SIGNATURE_SYMBOL,ASPECT,"for",SIGNATURE_SYMBOL,CARRIER,"match",SIGNATURE_SYMBOL,EXPECTATION,"do",SIGNATURE_OPTIONAL,SIGNATURE_SYMBOL,ACTION,"with",SIGNATURE_OPTIONAL,SIGNATURE_SYMBOL,PARAMS,"until",SIGNATURE_OPTIONAL,SIGNATURE_SYMBOL,END_CONDITIONS,0);
  ...
  sP(SYS_CONTEXT,QUOTE,"quote a process so that it can be passed as a value","result",SIGNATURE_STRUCTURE,TREE,"process",SIGNATURE_PROCESS,NULL_PROCESS,0);
  ...
  sP(SYS_CONTEXT,STREAM_READ,"read from a stream","result",SIGNATURE_STRUCTURE,TREE,"stream",SIGNATURE_STRUCTURE,STREAM,"into",SIGNATURE_SYMBOL,RESULT_SYMBOL,0);
  sP(SYS_CONTEXT,STREAM_WRITE,"write to a stream","result",SIGNATURE_STRUCTURE,TREE,"stream",SIGNATURE_STRUCTURE,STREAM,"what",SIGNATURE_ANY,NULL_STRUCTURE,0);
