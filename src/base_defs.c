...
void base_defs() {
  ...
  sTs(SYS_CONTEXT,LIST_OF_RECEPTOR_ADDRESS_AND_RECEPTOR_ADDRESS_AND_ASPECT_AND_CARRIER_AND_SIGNAL_UUID_AND_BODY,sT_SEQ(6,sT_SYM(RECEPTOR_ADDRESS),sT_SYM(RECEPTOR_ADDRESS),sT_SYM(ASPECT),sT_SYM(CARRIER),sT_SYM(SIGNAL_UUID),sT_SYM(BODY)));
  sY(SYS_CONTEXT,ENVELOPE,LIST_OF_RECEPTOR_ADDRESS_AND_RECEPTOR_ADDRESS_AND_ASPECT_AND_CARRIER_AND_SIGNAL_UUID_AND_BODY);
