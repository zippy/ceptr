...
void base_defs() {
  ...
  sP(SYS_CONTEXT,SEND,"send a signal","response",SIGNATURE_STRUCTURE,TREE,"to",SIGNATURE_SYMBOL,RECEPTOR_ADDRESS,"message contents",SIGNATURE_ANY,NULL_STRUCTURE,"respond on",SIGNATURE_SYMBOL,RESPONSE_CARRIER,0);
