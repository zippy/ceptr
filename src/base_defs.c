...
void base_defs() {
  ...
  sY(SYS_CONTEXT,ANYBODY,NULL_STRUCTURE);
  sTs(SYS_CONTEXT,TUPLE_OF_ZERO_OR_MORE_OF_ROLE_AND_ZERO_OR_ONE_OF_ANYBODY,sT_SEQ(2,sT_STAR(sT_SYM(ROLE)),sT_QMRK(sT_SYM(ANYBODY))));
  sY(SYS_CONTEXT,SOURCE,TUPLE_OF_ZERO_OR_MORE_OF_ROLE_AND_ZERO_OR_ONE_OF_ANYBODY);
  ...
  sTs(SYS_CONTEXT,PROTOCOL_DEF,sT_SEQ(2,sT_PLUS(sT_SYM(ROLE)),sT_PLUS(sT_SYM(CONVERSATION))));
  sTs(SYS_CONTEXT,ONE_OR_MORE_OF_STRUCTURE_OF_PROTOCOL_DEF,sT_PLUS(sT_PCNT(PROTOCOL_DEF)));
  sYs(SYS_CONTEXT,PROTOCOLS,ONE_OR_MORE_OF_STRUCTURE_OF_PROTOCOL_DEF);
