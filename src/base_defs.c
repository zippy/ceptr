...
void base_defs() {
  ...
  sT(SYS_CONTEXT,STRUCTURE_DEF,1,NULL_SYMBOL);
  sY(SYS_CONTEXT,STRUCTURE_LABEL,CSTRING);
  sY(SYS_CONTEXT,STRUCTURE_DEFINITION,LIST);
  sYs(SYS_CONTEXT,STRUCTURES,LIST);
  sY(SYS_CONTEXT,STRUCTURE_SEQUENCE,LIST);
  sY(SYS_CONTEXT,STRUCTURE_SYMBOL_SET,LIST);
  sY(SYS_CONTEXT,STRUCTURE_SYMBOL,SYMBOL);
  sY(SYS_CONTEXT,STRUCTURE_OR,LIST);
  sY(SYS_CONTEXT,STRUCTURE_ZERO_OR_MORE,STRUCTURE_DEF);
  sY(SYS_CONTEXT,STRUCTURE_ONE_OR_MORE,STRUCTURE_DEF);
