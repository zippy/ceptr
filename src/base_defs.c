...
void base_sys_defs(SemTable *sem) {
  ...
  sTs(SYS_CONTEXT,LIST_OF_STRUCTURES_AND_SYMBOLS_AND_PROCESSES_AND_PROTOCOLS_AND_RECEPTORS_AND_ZERO_OR_MORE_OF_SCAPES_AND_ZERO_OR_MORE_OF_ASPECTS,sT_SEQ(7,sT_SYM(STRUCTURES),sT_SYM(SYMBOLS),sT_SYM(PROCESSES),sT_SYM(PROTOCOLS),sT_SYM(RECEPTORS),sT_STAR(sT_SYM(SCAPES)),sT_STAR(sT_SYM(ASPECTS))));
  sY(SYS_CONTEXT,DEFINITIONS,LIST_OF_STRUCTURES_AND_SYMBOLS_AND_PROCESSES_AND_PROTOCOLS_AND_RECEPTORS_AND_ZERO_OR_MORE_OF_SCAPES_AND_ZERO_OR_MORE_OF_ASPECTS);
  ...
  sT(SYS_CONTEXT,RECEPTOR_DEFINITION,5,DEFINITIONS,FLUX,RECEPTOR_STATE,PENDING_SIGNALS,PENDING_RESPONSES);
