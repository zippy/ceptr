...
void base_defs() {
  ...
  sTs(SYS_CONTEXT,STRUCTURE_DEF,sT_SET(8,sT_SYM(STRUCTURE_SYMBOL),sT_SYM(STRUCTURE_SEQUENCE),sT_SYM(STRUCTURE_SYMBOL_SET),sT_SYM(STRUCTURE_OR),sT_SYM(STRUCTURE_ZERO_OR_MORE),sT_SYM(STRUCTURE_ONE_OR_MORE),sT_SYM(STRUCTURE_ZERO_OR_ONE),sT_SYM(SYMBOL_OF_STRUCTURE)));
  ...
  sTs(SYS_CONTEXT,TUPLE_OF_ASPECT_TYPE_AND_TREE,sT_SEQ(2,sT_SYM(ASPECT_TYPE),sT_SYM(TREE)));
  sY(SYS_CONTEXT,ASPECT_DEF,TUPLE_OF_ASPECT_TYPE_AND_TREE);
  ...
  sTs(SYS_CONTEXT,LIST_OF_RECEPTOR_ADDRESS_AND_RECEPTOR_ADDRESS_AND_ASPECT_IDENT_AND_CARRIER_AND_SIGNAL_UUID_AND_ZERO_OR_ONE_OF_LOGICAL_OR_OF_END_CONDITIONS_AND_IN_RESPONSE_TO_UUID,sT_SEQ(6,sT_SYM(RECEPTOR_ADDRESS),sT_SYM(RECEPTOR_ADDRESS),sT_SYM(ASPECT_IDENT),sT_SYM(CARRIER),sT_SYM(SIGNAL_UUID),sT_QMRK(sT_OR(sT_SYM(END_CONDITIONS),sT_SYM(IN_RESPONSE_TO_UUID)))));
  sY(SYS_CONTEXT,ENVELOPE,LIST_OF_RECEPTOR_ADDRESS_AND_RECEPTOR_ADDRESS_AND_ASPECT_IDENT_AND_CARRIER_AND_SIGNAL_UUID_AND_ZERO_OR_ONE_OF_LOGICAL_OR_OF_END_CONDITIONS_AND_IN_RESPONSE_TO_UUID);
  ...
  sP(SYS_CONTEXT,SAY,"send a message to a receptor","signal id",SIGNATURE_SYMBOL,SIGNAL_UUID,"to",SIGNATURE_SYMBOL,RECEPTOR_ADDRESS,"on",SIGNATURE_SYMBOL,ASPECT_IDENT,"message",SIGNATURE_ANY,NULL_STRUCTURE);
