...
enum {D_NONE=0x0000,D_ALL=0xFFFF,D_SPEC=0x8000,D_SIGNALS=0x0001,D_REDUCE=0x0002,D_REDUCEV=0x0004,D_STX_MATCH=0x0008,D_CLOCK=0x0010,D_STREAM=0x0020,D_LOCK=0x0040,D_LISTEN=0x0080,D_PROTOCOL=0x0100,D_TREE=0x0200,D_TRANSCODE=0x0400,D_STEP=0x0800,D_SOCKET=0x1000};
