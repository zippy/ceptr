...
SemanticID HTTP_RESPONSE_CONTENT_TYPE;
...
enum INTERNETStructureIDs {
    ...
    URI_ID,
    HTTP_REQUEST_V09_ID,
    LIST_OF_HTTP_RESPONSE_CONTENT_TYPE_AND_HTTP_RESPONSE_BODY_AND_HTTP_RESPONSE_STATUS_ID,
...
SemanticID LIST_OF_HTTP_RESPONSE_CONTENT_TYPE_AND_HTTP_RESPONSE_BODY_AND_HTTP_RESPONSE_STATUS;
