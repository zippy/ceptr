...
#define RECEPTORS G_contexts[SYS_CONTEXT].symbols[RECEPTORS_ID]
...
#define SYMBOL_OF_STRUCTURE G_contexts[SYS_CONTEXT].symbols[SYMBOL_OF_STRUCTURE_ID]
#define STRUCTURE_ANYTHING G_contexts[SYS_CONTEXT].symbols[STRUCTURE_ANYTHING_ID]
...
#define SYMBOL_DEFINITION G_contexts[SYS_CONTEXT].symbols[SYMBOL_DEFINITION_ID]
...
#define DEFAULT_ASPECT G_contexts[SYS_CONTEXT].symbols[DEFAULT_ASPECT_ID]
#define FLUX G_contexts[SYS_CONTEXT].symbols[FLUX_ID]
#define SCAPE_SPEC G_contexts[SYS_CONTEXT].symbols[SCAPE_SPEC_ID]
#define ASPECT_IDENT G_contexts[SYS_CONTEXT].symbols[ASPECT_IDENT_ID]
#define ASPECT_TYPE G_contexts[SYS_CONTEXT].symbols[ASPECT_TYPE_ID]
#define ASPECT_LABEL G_contexts[SYS_CONTEXT].symbols[ASPECT_LABEL_ID]
...
#define CONTEXT_NUM G_contexts[SYS_CONTEXT].symbols[CONTEXT_NUM_ID]
#define RECEPTOR_PATH G_contexts[SYS_CONTEXT].symbols[RECEPTOR_PATH_ID]
#define FROM_ADDRESS G_contexts[SYS_CONTEXT].symbols[FROM_ADDRESS_ID]
#define TO_ADDRESS G_contexts[SYS_CONTEXT].symbols[TO_ADDRESS_ID]
...
#define CODE G_contexts[SYS_CONTEXT].symbols[CODE_ID]
#define PROCESS_DEFINITION G_contexts[SYS_CONTEXT].symbols[PROCESS_DEFINITION_ID]
...
#define ROLE G_contexts[SYS_CONTEXT].symbols[ROLE_ID]
#define GOAL G_contexts[SYS_CONTEXT].symbols[GOAL_ID]
#define USAGE G_contexts[SYS_CONTEXT].symbols[USAGE_ID]
#define SOURCE G_contexts[SYS_CONTEXT].symbols[SOURCE_ID]
#define DESTINATION G_contexts[SYS_CONTEXT].symbols[DESTINATION_ID]
#define EXPECT G_contexts[SYS_CONTEXT].symbols[EXPECT_ID]
#define INITIATE G_contexts[SYS_CONTEXT].symbols[INITIATE_ID]
#define PNAME G_contexts[SYS_CONTEXT].symbols[PNAME_ID]
#define INCLUSION G_contexts[SYS_CONTEXT].symbols[INCLUSION_ID]
#define ACTUAL_PROCESS G_contexts[SYS_CONTEXT].symbols[ACTUAL_PROCESS_ID]
#define ACTUAL_RECEPTOR G_contexts[SYS_CONTEXT].symbols[ACTUAL_RECEPTOR_ID]
#define ACTUAL_SYMBOL G_contexts[SYS_CONTEXT].symbols[ACTUAL_SYMBOL_ID]
#define WHICH_PROCESS G_contexts[SYS_CONTEXT].symbols[WHICH_PROCESS_ID]
#define WHICH_RECEPTOR G_contexts[SYS_CONTEXT].symbols[WHICH_RECEPTOR_ID]
#define WHICH_SYMBOL G_contexts[SYS_CONTEXT].symbols[WHICH_SYMBOL_ID]
#define RESOLUTION G_contexts[SYS_CONTEXT].symbols[RESOLUTION_ID]
#define WHICH_GOAL G_contexts[SYS_CONTEXT].symbols[WHICH_GOAL_ID]
#define WHICH_ROLE G_contexts[SYS_CONTEXT].symbols[WHICH_ROLE_ID]
#define WHICH_USAGE G_contexts[SYS_CONTEXT].symbols[WHICH_USAGE_ID]
#define CONNECTION G_contexts[SYS_CONTEXT].symbols[CONNECTION_ID]
#define PROTOCOL_BINDINGS G_contexts[SYS_CONTEXT].symbols[PROTOCOL_BINDINGS_ID]
#define PROTOCOL_LABEL G_contexts[SYS_CONTEXT].symbols[PROTOCOL_LABEL_ID]
#define PROTOCOL_DEFINITION G_contexts[SYS_CONTEXT].symbols[PROTOCOL_DEFINITION_ID]
...
#define RECEPTOR_LABEL G_contexts[SYS_CONTEXT].symbols[RECEPTOR_LABEL_ID]
...
#define DEV_SANDBOX G_contexts[SYS_CONTEXT].symbols[DEV_SANDBOX_ID]
#define TEST_SANDBOX G_contexts[SYS_CONTEXT].symbols[TEST_SANDBOX_ID]
...
#define UNLIMITED G_contexts[SYS_CONTEXT].symbols[UNLIMITED_ID]
...
enum SYSStructureIDs {
    ...
    UUID_ID,
    BLOB_ID,
    LIST_OF_STRUCTURES_AND_SYMBOLS_AND_PROCESSES_AND_PROTOCOLS_AND_RECEPTORS_AND_ZERO_OR_MORE_OF_SCAPES_AND_ZERO_OR_MORE_OF_ASPECTS_ID,
    STRUCTURE_DEF_ID,
...
#define LIST_OF_STRUCTURES_AND_SYMBOLS_AND_PROCESSES_AND_PROTOCOLS_AND_RECEPTORS_AND_ZERO_OR_MORE_OF_SCAPES_AND_ZERO_OR_MORE_OF_ASPECTS G_contexts[SYS_CONTEXT].structures[LIST_OF_STRUCTURES_AND_SYMBOLS_AND_PROCESSES_AND_PROTOCOLS_AND_RECEPTORS_AND_ZERO_OR_MORE_OF_SCAPES_AND_ZERO_OR_MORE_OF_ASPECTS_ID]
...
#define ZERO_OR_MORE_OF_SYMBOL_DEFINITION G_contexts[SYS_CONTEXT].structures[ZERO_OR_MORE_OF_SYMBOL_DEFINITION_ID]
#define SEMTREX_DEF G_contexts[SYS_CONTEXT].structures[SEMTREX_DEF_ID]
#define ONE_OR_MORE_OF_SEMTREX_SYMBOL G_contexts[SYS_CONTEXT].structures[ONE_OR_MORE_OF_SEMTREX_SYMBOL_ID]
#define SEMTREX_SYMBOL_LITERAL_DEF G_contexts[SYS_CONTEXT].structures[SEMTREX_SYMBOL_LITERAL_DEF_ID]
#define ONE_OR_MORE_OF_SEMTREX_DEF G_contexts[SYS_CONTEXT].structures[ONE_OR_MORE_OF_SEMTREX_DEF_ID]
#define PAIR_OF_SEMTREX_DEF G_contexts[SYS_CONTEXT].structures[PAIR_OF_SEMTREX_DEF_ID]
#define ZERO_OR_ONE_OF_ANY_SYMBOL G_contexts[SYS_CONTEXT].structures[ZERO_OR_ONE_OF_ANY_SYMBOL_ID]
#define ONE_OR_MORE_OF_ANY_SYMBOL G_contexts[SYS_CONTEXT].structures[ONE_OR_MORE_OF_ANY_SYMBOL_ID]
#define SEMTREX_VALUE_LITERAL_DEF G_contexts[SYS_CONTEXT].structures[SEMTREX_VALUE_LITERAL_DEF_ID]
#define ONE_OR_MORE_OF_ASCII_CHAR G_contexts[SYS_CONTEXT].structures[ONE_OR_MORE_OF_ASCII_CHAR_ID]
#define ASPECT G_contexts[SYS_CONTEXT].structures[ASPECT_ID]
#define ONE_OR_MORE_OF_STRUCTURE_OF_ASPECT G_contexts[SYS_CONTEXT].structures[ONE_OR_MORE_OF_STRUCTURE_OF_ASPECT_ID]
#define TUPLE_OF_ASPECT_TYPE_AND_ASPECT_LABEL G_contexts[SYS_CONTEXT].structures[TUPLE_OF_ASPECT_TYPE_AND_ASPECT_LABEL_ID]
#define ONE_OR_MORE_OF_ASPECT_DEF G_contexts[SYS_CONTEXT].structures[ONE_OR_MORE_OF_ASPECT_DEF_ID]
#define RECEPTOR_ADDRESS G_contexts[SYS_CONTEXT].structures[RECEPTOR_ADDRESS_ID]
#define LIST_OF_FROM_ADDRESS_AND_TO_ADDRESS_AND_ASPECT_IDENT_AND_CARRIER_AND_SIGNAL_UUID_AND_ZERO_OR_ONE_OF_LOGICAL_OR_OF_END_CONDITIONS_AND_IN_RESPONSE_TO_UUID G_contexts[SYS_CONTEXT].structures[LIST_OF_FROM_ADDRESS_AND_TO_ADDRESS_AND_ASPECT_IDENT_AND_CARRIER_AND_SIGNAL_UUID_AND_ZERO_OR_ONE_OF_LOGICAL_OR_OF_END_CONDITIONS_AND_IN_RESPONSE_TO_UUID_ID]
...
#define LIST_OF_CARRIER_AND_PATTERN_AND_ACTION_AND_PARAMS_AND_END_CONDITIONS G_contexts[SYS_CONTEXT].structures[LIST_OF_CARRIER_AND_PATTERN_AND_ACTION_AND_PARAMS_AND_END_CONDITIONS_ID]
#define ZERO_OR_MORE_OF_EXPECTATION G_contexts[SYS_CONTEXT].structures[ZERO_OR_MORE_OF_EXPECTATION_ID]
#define ANY_SYMBOL G_contexts[SYS_CONTEXT].structures[ANY_SYMBOL_ID]
#define LIST_OF_PROCESS_NAME_AND_PROCESS_INTENTION_AND_CODE_AND_PROCESS_SIGNATURE G_contexts[SYS_CONTEXT].structures[LIST_OF_PROCESS_NAME_AND_PROCESS_INTENTION_AND_CODE_AND_PROCESS_SIGNATURE_ID]
#define ZERO_OR_MORE_OF_PROCESS_DEFINITION G_contexts[SYS_CONTEXT].structures[ZERO_OR_MORE_OF_PROCESS_DEFINITION_ID]
...
#define PROCESS_FORM G_contexts[SYS_CONTEXT].structures[PROCESS_FORM_ID]
#define LIST_OF_CODE_AND_PARAMS_AND_ZERO_OR_ONE_OF_CODE G_contexts[SYS_CONTEXT].structures[LIST_OF_CODE_AND_PARAMS_AND_ZERO_OR_ONE_OF_CODE_ID]
#define ZERO_OR_MORE_OF_ANY_SYMBOL G_contexts[SYS_CONTEXT].structures[ZERO_OR_MORE_OF_ANY_SYMBOL_ID]
#define ONE_OR_MORE_OF_ROLE G_contexts[SYS_CONTEXT].structures[ONE_OR_MORE_OF_ROLE_ID]
#define LIST_OF_ROLE_AND_SOURCE_AND_PATTERN_AND_ACTION G_contexts[SYS_CONTEXT].structures[LIST_OF_ROLE_AND_SOURCE_AND_PATTERN_AND_ACTION_ID]
#define LIST_OF_ROLE_AND_DESTINATION_AND_ACTION G_contexts[SYS_CONTEXT].structures[LIST_OF_ROLE_AND_DESTINATION_AND_ACTION_ID]
#define TUPLE_OF_PNAME_AND_ONE_OR_MORE_OF_LOGICAL_OR_OF_RESOLUTION_AND_CONNECTION G_contexts[SYS_CONTEXT].structures[TUPLE_OF_PNAME_AND_ONE_OR_MORE_OF_LOGICAL_OR_OF_RESOLUTION_AND_CONNECTION_ID]
#define INTERACTION G_contexts[SYS_CONTEXT].structures[INTERACTION_ID]
#define ZERO_OR_MORE_OF_PROTOCOL_DEFINITION G_contexts[SYS_CONTEXT].structures[ZERO_OR_MORE_OF_PROTOCOL_DEFINITION_ID]
#define TUPLE_OF_GOAL_AND_ACTUAL_PROCESS G_contexts[SYS_CONTEXT].structures[TUPLE_OF_GOAL_AND_ACTUAL_PROCESS_ID]
#define TUPLE_OF_ROLE_AND_ACTUAL_RECEPTOR G_contexts[SYS_CONTEXT].structures[TUPLE_OF_ROLE_AND_ACTUAL_RECEPTOR_ID]
#define TUPLE_OF_USAGE_AND_ACTUAL_SYMBOL G_contexts[SYS_CONTEXT].structures[TUPLE_OF_USAGE_AND_ACTUAL_SYMBOL_ID]
#define MAPPING G_contexts[SYS_CONTEXT].structures[MAPPING_ID]
#define PAIR_OF_GOAL G_contexts[SYS_CONTEXT].structures[PAIR_OF_GOAL_ID]
#define PAIR_OF_ROLE G_contexts[SYS_CONTEXT].structures[PAIR_OF_ROLE_ID]
#define PAIR_OF_USAGE G_contexts[SYS_CONTEXT].structures[PAIR_OF_USAGE_ID]
#define LINKING G_contexts[SYS_CONTEXT].structures[LINKING_ID]
#define ONE_OR_MORE_OF_RESOLUTION G_contexts[SYS_CONTEXT].structures[ONE_OR_MORE_OF_RESOLUTION_ID]
#define LIST_OF_PROTOCOL_LABEL_AND_ZERO_OR_MORE_OF_ROLE_AND_ZERO_OR_MORE_OF_GOAL_AND_ZERO_OR_MORE_OF_USAGE_AND_ZERO_OR_MORE_OF_STRUCTURE_OF_INTERACTION_AND_ZERO_OR_MORE_OF_INCLUSION G_contexts[SYS_CONTEXT].structures[LIST_OF_PROTOCOL_LABEL_AND_ZERO_OR_MORE_OF_ROLE_AND_ZERO_OR_MORE_OF_GOAL_AND_ZERO_OR_MORE_OF_USAGE_AND_ZERO_OR_MORE_OF_STRUCTURE_OF_INTERACTION_AND_ZERO_OR_MORE_OF_INCLUSION_ID]
#define ZERO_OR_MORE_OF_STRUCTURE_OF_SCAPE G_contexts[SYS_CONTEXT].structures[ZERO_OR_MORE_OF_STRUCTURE_OF_SCAPE_ID]
#define TUPLE_OF_MANIFEST_LABEL_AND_MANIFEST_SPEC G_contexts[SYS_CONTEXT].structures[TUPLE_OF_MANIFEST_LABEL_AND_MANIFEST_SPEC_ID]
#define ONE_OR_MORE_OF_MANIFEST_PAIR G_contexts[SYS_CONTEXT].structures[ONE_OR_MORE_OF_MANIFEST_PAIR_ID]
#define LIST_OF_MANIFEST_AND_RECEPTOR_IDENTIFIER_AND_DEFINITIONS G_contexts[SYS_CONTEXT].structures[LIST_OF_MANIFEST_AND_RECEPTOR_IDENTIFIER_AND_DEFINITIONS_ID]
#define TUPLE_OF_MANIFEST_LABEL_AND_ANY_SYMBOL G_contexts[SYS_CONTEXT].structures[TUPLE_OF_MANIFEST_LABEL_AND_ANY_SYMBOL_ID]
#define ONE_OR_MORE_OF_BINDING_PAIR G_contexts[SYS_CONTEXT].structures[ONE_OR_MORE_OF_BINDING_PAIR_ID]
...
#define RECEPTOR_IDENTITY G_contexts[SYS_CONTEXT].structures[RECEPTOR_IDENTITY_ID]
#define RECEPTOR_DEFINITION G_contexts[SYS_CONTEXT].structures[RECEPTOR_DEFINITION_ID]
#define ZERO_OR_MORE_OF_RECEPTOR_DEFINITION G_contexts[SYS_CONTEXT].structures[ZERO_OR_MORE_OF_RECEPTOR_DEFINITION_ID]
...
#define LOGICAL_OR_OF_COUNT_AND_UNLIMITED G_contexts[SYS_CONTEXT].structures[LOGICAL_OR_OF_COUNT_AND_UNLIMITED_ID]
...
#define STX_TOKEN_LIST G_contexts[SYS_CONTEXT].structures[STX_TOKEN_LIST_ID]
