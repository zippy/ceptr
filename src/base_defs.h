...
enum SYSStructureIDs {
    ...
    LIST_OF_ROLE_AND_SOURCE_AND_EXPECTATION_ID,
...
#define LIST_OF_ROLE_AND_SOURCE_AND_EXPECTATION G_contexts[SYS_CONTEXT].structures[LIST_OF_ROLE_AND_SOURCE_AND_EXPECTATION_ID]
