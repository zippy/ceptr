...
enum SYSStructureIDs {
    ...
    LIST_OF_SIGNAL_UUID_AND_CARRIER_AND_WAKEUP_REFERENCE_ID,
...
#define LIST_OF_SIGNAL_UUID_AND_CARRIER_AND_WAKEUP_REFERENCE G_contexts[SYS_CONTEXT].structures[LIST_OF_SIGNAL_UUID_AND_CARRIER_AND_WAKEUP_REFERENCE_ID]
