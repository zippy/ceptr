...
enum SYSStructureIDs {
    ...
    LIST_OF_ROLE_AND_SOURCE_AND_PATTERN_SYMBOL_AND_ACTION_ID,
    ...
    TUPLE_OF_SEMANTIC_REFERENCE_AND_ZERO_OR_ONE_OF_SLOT_IS_VALUE_OF_ID,
    TUPLE_OF_SEMANTIC_REFERENCE_AND_REPLACEMENT_VALUE_ID,
    LIST_OF_ONE_OR_MORE_OF_SEMANTIC_MAP_ID,
    ...
    LIST_OF_ZERO_OR_MORE_OF_ROLE_AND_ZERO_OR_MORE_OF_GOAL_AND_ZERO_OR_MORE_OF_USAGE_ID,
...
SemanticID LIST_OF_ROLE_AND_SOURCE_AND_PATTERN_SYMBOL_AND_ACTION;
...
SemanticID TUPLE_OF_SEMANTIC_REFERENCE_AND_ZERO_OR_ONE_OF_SLOT_IS_VALUE_OF;
SemanticID TUPLE_OF_SEMANTIC_REFERENCE_AND_REPLACEMENT_VALUE;
SemanticID LIST_OF_ONE_OR_MORE_OF_SEMANTIC_MAP;
...
SemanticID LIST_OF_ZERO_OR_MORE_OF_ROLE_AND_ZERO_OR_MORE_OF_GOAL_AND_ZERO_OR_MORE_OF_USAGE;
