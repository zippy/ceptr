...
SemanticID ENVELOPE;
SemanticID TOPIC;
SemanticID CONVERSTATION_IDENT;
...
enum SYSStructureIDs {
    ...
    LIST_OF_CONVERSATION_UUID_AND_ZERO_OR_ONE_OF_TOPIC_AND_ZERO_OR_ONE_OF_CONVERSTATION_IDENT_ID,
...
SemanticID LIST_OF_CONVERSATION_UUID_AND_ZERO_OR_ONE_OF_TOPIC_AND_ZERO_OR_ONE_OF_CONVERSTATION_IDENT;
