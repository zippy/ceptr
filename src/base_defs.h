...
#define TEST_INT_SYMBOL G_contexts[SYS_CONTEXT].symbols[TEST_INT_SYMBOL_ID]
#define TEST_INT_SYMBOL2 G_contexts[SYS_CONTEXT].symbols[TEST_INT_SYMBOL2_ID]
#define TEST_FLOAT_SYMBOL G_contexts[SYS_CONTEXT].symbols[TEST_FLOAT_SYMBOL_ID]
#define TEST_STR_SYMBOL G_contexts[SYS_CONTEXT].symbols[TEST_STR_SYMBOL_ID]
#define TEST_TREE_SYMBOL G_contexts[SYS_CONTEXT].symbols[TEST_TREE_SYMBOL_ID]
#define TEST_TREE_SYMBOL2 G_contexts[SYS_CONTEXT].symbols[TEST_TREE_SYMBOL2_ID]
#define TEST_STREAM_SYMBOL G_contexts[SYS_CONTEXT].symbols[TEST_STREAM_SYMBOL_ID]
#define TEST_NAME_SYMBOL G_contexts[SYS_CONTEXT].symbols[TEST_NAME_SYMBOL_ID]
#define TEST_RECEPTOR_SYMBOL G_contexts[SYS_CONTEXT].symbols[TEST_RECEPTOR_SYMBOL_ID]
#define TEST_ALPHABETIZE_SCAPE_SYMBOL G_contexts[SYS_CONTEXT].symbols[TEST_ALPHABETIZE_SCAPE_SYMBOL_ID]
