...
enum SYSStructureIDs {
    ...
    LIST_OF_CONVERSATION_UUID_AND_ZERO_OR_ONE_OF_TOPIC_AND_ZERO_OR_ONE_OF_CONVERSATION_IDENT_ID,
...
SemanticID LIST_OF_CONVERSATION_UUID_AND_ZERO_OR_ONE_OF_TOPIC_AND_ZERO_OR_ONE_OF_CONVERSATION_IDENT;
