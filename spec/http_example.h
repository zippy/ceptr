...
void _setup_HTTPDefs() {
    ...
    TSYM_HTTP_REQUEST = _d_def_symbol(test_HTTP_symbols,TREE,"HTTP_REQUEST");
    TSYM_HTTP_REQUEST_METHOD = _d_def_symbol(test_HTTP_symbols,INTEGER,"HTTP_REQUEST_METHOD");
    TSYM_HTTP_REQUEST_PATH = _d_def_symbol(test_HTTP_symbols,TREE,"HTTP_REQUEST_PATH");
    TSYM_HTTP_REQUEST_PATH_SEGMENTS = _d_def_symbol(test_HTTP_symbols,LIST,"HTTP_REQUEST_PATH_SEGMENTS");
    TSYM_HTTP_REQUEST_PATH_SEGMENT = _d_def_symbol(test_HTTP_symbols,CSTRING,"HTTP_REQUEST_PATH_SEGMENT");
    TSYM_HTTP_REQUEST_PATH_FILE = _d_def_symbol(test_HTTP_symbols,LIST,"HTTP_REQUEST_PATH_FILE");
    TSYM_HTTP_REQUEST_PATH_FILE_NAME = _d_def_symbol(test_HTTP_symbols,CSTRING,"HTTP_REQUEST_PATH_FILE_NAME");
    TSYM_HTTP_REQUEST_PATH_FILE_EXTENSION = _d_def_symbol(test_HTTP_symbols,CSTRING,"HTTP_REQUEST_PATH_FILE_EXTENSION");
    TSYM_HTTP_REQUEST_PATH_QUERY = _d_def_symbol(test_HTTP_symbols,LIST,"HTTP_REQUEST_PATH_QUERY");
    TSYM_HTTP_REQUEST_PATH_QUERY_PARAMS = _d_def_symbol(test_HTTP_symbols,LIST,"HTTP_REQUEST_PATH_QUERY_PARAMS");
    TSYM_HTTP_REQUEST_PATH_QUERY_PARAM = _d_def_symbol(test_HTTP_symbols,TREE,"HTTP_REQUEST_PATH_QUERY_PARAM");
    TSYM_HTTP_REQUEST_PATH_QUERY_PARAM_KEY = _d_def_symbol(test_HTTP_symbols,CSTRING,"HTTP_REQUEST_PATH_QUERY_PARAM_KEY");
    TSYM_HTTP_REQUEST_PATH_QUERY_PARAM_VALUE = _d_def_symbol(test_HTTP_symbols,CSTRING,"HTTP_REQUEST_PATH_QUERY_PARAM_VALUE");
    TSYM_HTTP_REQUEST_VERSION = _d_def_symbol(test_HTTP_symbols,TREE,"HTTP_REQUEST_VERSION");
    TSYM_HTTP_REQUEST_VERSION_MAJOR = _d_def_symbol(test_HTTP_symbols,INTEGER,"HTTP_REQUEST_VERSION_MAJOR");
    TSYM_HTTP_REQUEST_VERSION_MINOR = _d_def_symbol(test_HTTP_symbols,INTEGER,"HTTP_REQUEST_VERSION_MINOR");
}
