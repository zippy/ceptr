...
void testSemtrexParse() {
    ...
    s = parseSemtrex(&d,stx);
    spec_is_str_equal(_dump_semtrex(&d,s,buf),stx);
    spec_is_str_equal(__t_dump(&d,s,0,buf)," (SEMTREX_VALUE_LITERAL (SEMTREX_VALUE_SET (TEST_STR_SYMBOL:fish)))");
    _t_free(s);
...
void testEmbodyFromMatch() {
    ...
    spec_is_str_equal(__t_dump(0,s,0,buf)," (SEMTREX_SYMBOL_LITERAL (SEMTREX_SYMBOL_SET (SEMTREX_SYMBOL:ASCII_CHARS)) (SEMTREX_GROUP:LABELED_PAIR (SEMTREX_SEQUENCE (SEMTREX_GROUP:LABEL (SEMTREX_ONE_OR_MORE (SEMTREX_SYMBOL_LITERAL (SEMTREX_SYMBOL_SET (SEMTREX_SYMBOL:ASCII_CHAR))))) (SEMTREX_GROUP:NULL_SYMBOL (SEMTREX_VALUE_LITERAL (SEMTREX_VALUE_SET (ASCII_CHAR:':')))) (SEMTREX_GROUP:X1 (SEMTREX_ONE_OR_MORE (SEMTREX_SYMBOL_LITERAL (SEMTREX_SYMBOL_SET (SEMTREX_SYMBOL:ASCII_CHAR))))) (SEMTREX_GROUP:NULL_SYMBOL (SEMTREX_VALUE_LITERAL (SEMTREX_VALUE_SET (ASCII_CHAR:',')))) (SEMTREX_GROUP:X2 (SEMTREX_ONE_OR_MORE (SEMTREX_SYMBOL_LITERAL (SEMTREX_SYMBOL_SET (SEMTREX_SYMBOL:ASCII_CHAR))))))))");
