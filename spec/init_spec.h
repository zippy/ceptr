...
void testInit() {
    ...
    spec_is_equal( (int)size_table_get(getSymbol(r, "NOUN")), (int)noun_get_size );
    ...
    spec_is_equal( (int)size_table_get(getSymbol(r, "PATTERN")), (int)pattern_get_spec_size );
    ...
    spec_is_equal( (int)size_table_get(getSymbol(r, "ARRAY")), (int)array_get_spec_size );
